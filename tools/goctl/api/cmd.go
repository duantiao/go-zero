...
import (
	...
	"github.com/duantiao/go-zero/tools/goctl/api/apigen"
	"github.com/duantiao/go-zero/tools/goctl/api/dartgen"
	"github.com/duantiao/go-zero/tools/goctl/api/docgen"
	"github.com/duantiao/go-zero/tools/goctl/api/format"
	"github.com/duantiao/go-zero/tools/goctl/api/gogen"
	"github.com/duantiao/go-zero/tools/goctl/api/javagen"
	"github.com/duantiao/go-zero/tools/goctl/api/ktgen"
	"github.com/duantiao/go-zero/tools/goctl/api/new"
	"github.com/duantiao/go-zero/tools/goctl/api/swagger"
	"github.com/duantiao/go-zero/tools/goctl/api/tsgen"
	"github.com/duantiao/go-zero/tools/goctl/api/validate"
	"github.com/duantiao/go-zero/tools/goctl/config"
	"github.com/duantiao/go-zero/tools/goctl/internal/cobrax"
	"github.com/duantiao/go-zero/tools/goctl/plugin"
)
