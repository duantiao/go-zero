...
import (
	...
	"github.com/duantiao/go-zero/tools/goctl/api"
	"github.com/duantiao/go-zero/tools/goctl/bug"
	"github.com/duantiao/go-zero/tools/goctl/config"
	"github.com/duantiao/go-zero/tools/goctl/docker"
	"github.com/duantiao/go-zero/tools/goctl/env"
	"github.com/duantiao/go-zero/tools/goctl/gateway"
	"github.com/duantiao/go-zero/tools/goctl/internal/cobrax"
	"github.com/duantiao/go-zero/tools/goctl/internal/version"
	"github.com/duantiao/go-zero/tools/goctl/kube"
	"github.com/duantiao/go-zero/tools/goctl/migrate"
	"github.com/duantiao/go-zero/tools/goctl/model"
	"github.com/duantiao/go-zero/tools/goctl/quickstart"
	"github.com/duantiao/go-zero/tools/goctl/rpc"
	"github.com/duantiao/go-zero/tools/goctl/tpl"
	"github.com/duantiao/go-zero/tools/goctl/upgrade"
